...
public class TransactionFactory {
    ...
    public static TransactionHistory createTransferTransaction(int timestamp, String description,
            ...
            , String currency) {
        return new MoneyTransferTransaction(timestamp, description, senderIBAN, receiverIBAN,
                amount, currency);
    }
    ...
    public static TransactionHistory createOnlineTransaction(int timestamp, String description,
        ...
        return new CardPaymentTransaction(timestamp, description, cardNumber, amount, currency,
                commerciant);
    }
